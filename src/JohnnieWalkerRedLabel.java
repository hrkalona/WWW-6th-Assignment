 ...
 * @author hrkalona2
 */
public class JohnnieWalkerRedLabel {
    private boolean flag;
    private int quantity;
    private HttpServletResponse response;   
    private HttpServletRequest request; 
    
    public JohnnieWalkerRedLabel() {
        flag = false;
        quantity = 0;
    }
        ...
        if(flag == false) {
            ...
            if(cookies != null) {
                for(int i = 0; i < cookies.length; i++) {
                    ...
                    if(cookie.getName().equals("JohnnieWalkerRedLabel")) {  
    ...
    public void setQuantity(String squantity) {
       ...
       Cookie cookie = new Cookie("JohnnieWalkerRedLabel", "" + quantity);
